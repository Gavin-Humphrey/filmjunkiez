...
class FilmModelTest(TestCase):
    ...
    def test_average_rating_calculation(self):
        ...
        film = Film.objects.create(
            title="Test Film", host=self.user, category=self.category
        )
        review1 = Review.objects.create(
            user=self.user, film=film, rating=4, body="Good movie"
        )
        review2 = Review.objects.create(
            user=self.user, film=film, rating=2, body="Average movie"
        )
    ...
    def test_save_method_with_image(self):
        ...
        film = Film.objects.create(
            title="Test Film", host=self.user, category=self.category, image=image_file
        )
...
class ReviewModelTest(TestCase):
    ...
    def test_review_creation(self):
        ...
        review = Review.objects.create(
            user=self.user, film=self.film, rating=4, body="Good movie"
        )
